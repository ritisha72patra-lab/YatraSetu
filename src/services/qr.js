...
function verifyQrText(qrText) {
  ...
  // NOTE: 'YATRASETU_VERIFICATION' is the on-the-wire protocol type baked into
  // already-printed/issued QR cards. Kept unchanged after the YatraSetu ->
  // Panthan rebrand so existing physical cards keep verifying correctly.
