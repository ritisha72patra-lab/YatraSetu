...
router.get('/helplines',async(_,res)=>{res.json({helplines:HELPLINES,note:'SOS alerts reach the Panthan admin control room. These public numbers are for direct emergency dialling and do not receive app data.'})});
