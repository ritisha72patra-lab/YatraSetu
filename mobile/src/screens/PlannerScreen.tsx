    ...
    <ScrollView style={s.wrap} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      {plan && (
        <View style={s.card}>
          ...
          <Text style={s.quote}>YatraSetu ₹{plan.quote.total.toLocaleString('en-IN')} · rivals from ₹{plan.quote.cheapestRival.toLocaleString('en-IN')} · save ₹{plan.quote.savings.toLocaleString('en-IN')}</Text>
